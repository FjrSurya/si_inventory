...
<!-- 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('qty_keluar') is-invalid @enderror" name="qty_keluar" value="{{ old('qty_keluar', $rsetBrkeluar->qty_keluar) }}" placeholder="Masukkan Jumlah Barang Masuk">
                                <!-- error message untuk tanggal keluar -->
                                @error('qty_keluar')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
