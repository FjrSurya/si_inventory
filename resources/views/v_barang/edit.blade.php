                                    ...
                                    <select class="form-select" name="kategori_id" aria-label="Default select example">
                                        @foreach($aKategori as $key=>$val)
                                            @if($rsetBarang->kategori_id==$key)
                                                <option value="{{ $rsetBarang->kategori_id }}" selected>{{ $rsetBarang->kategori->jenis }} - {{ $rsetBarang->kategori->kategori }}</option>
                                            @else
                                                <option value="{{ $val->id }}">{{ $val->jenis }} - {{ $val->kategori }}</option>
                                            @endif
                                        @endforeach 
                                    </select>
