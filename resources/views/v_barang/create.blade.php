                    ...
                    <div class="card-body">
                        <form action="{{ route('v_barang.store') }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('seri') is-invalid @enderror" name="seri" value="{{ old('seri') }}" placeholder="Masukkan Spesifikasi">
                                ...
                                <div class="form-check">
                                    ...
                                    <select class="form-select" name="kategori_id" aria-label="Default select example">
                                        ...
                                        @foreach ($aKategori as $kategori)
                                            <option value="{{ $kategori->id }}">{{ $kategori->jenis }} - {{ $kategori->kategori }}</option>
                                        @endforeach
